...
numActions = 3; % should be the maximum number of actions available at any point to other systems
...
availableS2Actions = [1 2 0; 2 3 0; 1 2 3];
...
availableS2Options = [1 2 0; 2 3 0; 1 2 3];
