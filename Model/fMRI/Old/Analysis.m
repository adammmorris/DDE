...
figure
subplot(2,3,1)
hist(PEs_1a_all(:,1),20); axis([-5 5 0 2*10^4]); title('1a: MFG');
subplot(2,3,2)
hist(PEs_1a_all(:,2),20); axis([-5 5 0 2*10^4]);  title('1a: MF');
subplot(2,3,3)
hist(PEs_1a_all(:,3),20); axis([-5 5 0 2*10^4]); title('1a: MB');

subplot(2,3,4)
hist(PEs_2b_all(:,1),20); axis([-5 5 0 2*10^4]); title('2b: MFG');
subplot(2,3,5)
hist(PEs_2b_all(:,2),20); axis([-5 5 0 2*10^4]); title('2b: MF');
subplot(2,3,6)
hist(PEs_2b_all(:,3),20); axis([-5 5 0 2*10^4]); title('2b: MB');
