...
numStates = 10; % AM: we can't really ignore the bottom level with the new way the computations are done
...
numActions = 2; % should be the maximum number of actions available at any point to other systems
numOptions = 6; % should be the maximum number of options available at any point to the MFG system
...
availableS2Actions = [1 2; 1 2; 1 2];
...
availableS2Options = [1 2; 3 4; 5 6];
...
likelyTransition(3,[1 2]) = [7 8];
likelyTransition(4,[1 2]) = [9 10];
...
subgoals = [2 3 0 0 0 0; 5 6 7 8 9 10]; % should be numStages x numOptions
