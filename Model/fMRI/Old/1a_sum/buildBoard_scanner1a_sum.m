...
numOptions = 2; % AM: This has to be 3 to allow for three options in S2
...
numActions = 2; % maximum number of possible actions for other systems
...
S2_states = 2:4;
S2_actions = 1; % In this version, only one available action at stage 2
S2_options = 1;
...
terminalactions = [1; 1; 1];
minNumTerminalActions = 1;
