...
%% NOTES
% There are a number of dimensions in these scripts now. The dimensions are:
%   numberSum: yes or no
%   MFG stage 2 is model-based: yes or no
%   Stage 2 structure: single actions (like Expt 1a), double independent actions (like Expt 1b), crossed actions (like Expt 2b)
% This particular script is:
%   numberSum: yes
%   MFG stage 2 is model-based: no
%   Stage 2 structure: single actions
...
function [earnings, results, negLLs, PEs, critPEs] = runModel_scanner1a_sum(params, boardName)
            ...
            for i = S1_actions
                ...
                for j = S2_states
                    ...
                    if ~all(S2_availableactions)
                         S2_availableactions = S2_availableactions(1:minNumTerminalActions);
                    end
