...
%% Inputs:
% params should be the 4x1 vector [lr,beta,mb_weight,smf_weight]
% I fixed the eligibility trace at .8

function [negLL] = getLikelihood_nullModel(params,numRounds,trialTypes,option1,option2,choices,state2,rewards)
