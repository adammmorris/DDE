...
path = 'C:\Personal\School\Brown\Psychology\DDE Project\Model\board_no5.mat';

%% Basic parameters
numOptions = 4; % # of horizontal choices
...
numFeatureValues = 2; % # of feature values for any given feature; i.e. for letter features, 1 = A, 2 = B, 3 = C
...
%% Features
% For trial type 1 (aka letters): 1 = A, 2 = B, 3 = C
...
features(2,:) = [1 1]; % blue A
features(3,:) = [2 1]; % blue B
features(4,:) = [1 2]; % red A
features(5,:) = [2 2]; % red B
%features(6,:) = [3 3]; % green C
