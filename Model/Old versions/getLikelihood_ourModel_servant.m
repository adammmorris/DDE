...
%% Inputs:
% params should be the 5x1 vector [lr,beta,mb_weight,smf_weight,goalLearner_weight]
% I fixed the eligiblity trace at .8

function [negLL] = getLikelihood_ourModel_servant(params,numRounds,trialTypes,option1,option2,choices,state2,rewards)
