...
unlikelyTrials = zeros(numDataPoints,1);
...
unlikelyTrials = logical(unlikelyTrials);
...
unlikelyTrials = removerows(unlikelyTrials,'ind',rowsToToss);
...
%csvwrite('Parsed_experimental.csv',[unlikely(unlikelyTrials) choices(unlikelyTrials) subjIDs(unlikelyTrials)]);