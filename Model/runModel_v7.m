...
function [earnings, negLL, results] = runModel_v7(agent_params, weights, numRounds, numAgents, servant, boardName, magicBoard)
...
criticalTrials = randsample((numPracticeRounds+1):(numTotalRounds-1),numCriticalTrials,false);
